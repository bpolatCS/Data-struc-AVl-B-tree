...
/**
    ...
    */
template <class Comparable>
void BinarySearchTree<Comparable>::insert( const Comparable & x ) //DÜZ INSERT
{
    insert(x,root );
}
...
/**
    ...
    * Set the new root.
    */
template <class Comparable> //PRIVATE INSERT
...
/**
    ...
    */
template <class Comparable> //DÜZ REMOVE
